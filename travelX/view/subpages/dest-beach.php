...
<head>
    <title>Beach Destinations - TravelX</title>
    <meta charset="utf-8" />
            ...
            <div class="container">
                <div class="row gtr-200">
                    <div class="col-8 col-12-mobile imp-mobile" id="content">
                        <article id="main">
                            <header>
                                <h2><a href="#">Exotic Beach Destinations</a></h2>
                                <p>
                            ...
                            <section>
                                ...
                                <p>
                                    Experience the crystal-clear waters and luxurious overwater bungalows in the
                                    Maldives. Perfect for a romantic getaway or a relaxing vacation.
                                </p>
                                <a href="#" class="image featured"><img src="../../view/images/maldives.jpg"
                                        alt="Maldives" /></a>
                                <a href="../../view/subpages/booking.php" class="button">Visit the Maldives</a>
                            ...
                            <section>
                                ...
                                <p>
                                    Known for its turquoise lagoons and vibrant coral reefs, Bora Bora is a top
                                    destination for snorkeling and diving enthusiasts.
                                </p>
                                <a href="#" class="image featured"><img src="../../view/images/borabora.jpg"
                                        alt="Bora Bora" /></a>
                                <a href="../../view/subpages/booking.php" class="button">Visit Bora Bora</a>
                            ...
                            <section>
                                ...
                                <p>
                                    Enjoy the diverse landscapes of Maui, from its stunning beaches to the scenic Hana
                                    Highway and the majestic Haleakalā National Park.
                                </p>
                                <a href="#" class="image featured"><img src="../../view/images/maui.jpg"
                                        alt="Maui" /></a>
                                <a href="../../view/subpages/booking.php" class="button">Visit Maui</a>
                            ...
                            <section>
                                ...
                                <p>
                                    Phuket offers vibrant nightlife, rich culture, and beautiful beaches, making it a
                                    favorite destination for travelers seeking adventure and relaxation.
                                </p>
                                <a href="#" class="image featured"><img src="../../view/images/phuket.jpg"
                                        alt="Phuket" /></a>
                                <a href="../../view/subpages/booking.php" class="button">Visit Phuket</a>
                ...
                <div class="row">
                    ...
                    <section class="col-4 col-12-mobile">
                        ...
                        <ul class="divided">
                            <li>
                                <article class="tweet">
                                    Just booked a trip to the Maldives with TravelX! #Excited
                                    <span class="timestamp">5 minutes ago</span>
                                </article>
                            </li>
                            <li>
                                <article class="tweet">
                                    Can't wait to relax on the beaches of Bora Bora. #Paradise
                                    <span class="timestamp">30 minutes ago</span>
                                </article>
                            </li>
                            <li>
                                <article class="tweet">
                                    Our trip to Maui was unforgettable, thanks TravelX! #Vacation
                                    <span class="timestamp">3 hours ago</span>
                                </article>
                            </li>
                            <li>
                                <article class="tweet">
                                    Phuket was a blast! Thanks for the great service, TravelX! #Adventure
                    ...
                    <section class="col-4 col-12-mobile">
                        ...
                        <ul class="divided">
                            ...
                            <li>
                                <article class="post stub">
                                    <header>
                                        <h3><a href="#">Best Time to Visit Maldives</a></h3>
                                    </header>
                            ...
                            <li>
                                <article class="post stub">
                                    <header>
                                        <h3><a href="#">Exploring Bora Bora's Reefs</a></h3>
                                    </header>
                            ...
                            <li>
                                <article class="post stub">
                                    <header>
                                        <h3><a href="#">Maui Travel Guide</a></h3>
                                    </header>
